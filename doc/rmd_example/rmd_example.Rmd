...
```{r horses-sd-table, message=FALSE, warning=FALSE}
horses_sd_table <- read_csv("../../results/horses_sd.csv")
largest_sd <- horses_sd_table$Province[1]
knitr::kable(horses_sd_table, caption = "Standard deviation of horse population by province")
```
...
```{r horse-pop-plot-largest-sd, out.width="90%", fig.cap= "Horse populations for the province with the largest standard deviation", }
